...
const Footer = () => {
    return (
        <footer aria-label="Site Footer" className="bg-gray-900 mb-0 pb-0">
            <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-md">
                    <strong
                        className="block text-center text-xl font-medium text-gray-200 sm:text-3xl"
                    >
                    ...
                    <form className="mt-6">
                        <div className="relative max-w-lg">
                            ...
                            <button
                                className="absolute top-1/2 right-1 -translate-y-1/2 rounded-full bg-gray-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-gray-700"
                                type="button"
                            >
                                Subscribe
                            </button>
