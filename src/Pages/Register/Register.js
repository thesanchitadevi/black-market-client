    ...
    return (
        <div className="w-full mx-auto max-w-md p-4 rounded-md shadow sm:p-8  text-gray-700 my-10">
            ...
            <div className="my-6 space-y-4">
                <button onClick={handleGoogleSignIn} ariaLabel="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-400 focus:ring-cyan-400">
